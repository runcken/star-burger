...
## Как запустить dev-версию сайта(без Docker) локально
...
## Как запустить dev-версию сайта через Docker локально

Необходимо изменить в .env DB_HOST=db и выполнить:
